...
`docker run -t --memory 4096m --rm -p 5000:5000 -e ENGINE=$ENGINE minggli/chatbot python -m chatbot.services.ask`  

`docker run -t --memory 4096m --rm -p 5001:5001 minggli/chatbot python -m chatbot.services.symptoms`  
